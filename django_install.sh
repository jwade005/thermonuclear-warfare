...
pip install Django==2.1.3 #installs latest stable release of django

echo "Django admin is version:"

django-admin --version
django-admin startproject thermonuclear-warfare
...
sudo chmod 644 /opt/django/thermonuclear-warfare/manage.py
sudo setenforce 0

source /opt/django/django-env/bin/activate

cd /opt/django/thermonuclear-warfare
...
sed -i "s/        'ENGINE': 'django.db.backends.sqlite3',/        'ENGINE': 'django.db.backends.postgresql_psycopg2',/g" /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "s/        'NAME': os.path.join(BASE_DIR, 'db.sqlite3'),/        'NAME': 'project1',/g" /opt/django/thermonuclear-warfare/project1/settings.py
sed -i "80i 'USER': 'project1'," /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "81i 'PASSWORD': 'P@ssw0rd1'," /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "82i 'HOST': 'NEEDTOADDIP'," /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "83i 'PORT': '5432'," /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "s/'USER': 'project1',/        'USER': 'project1',/g" /opt/django/thermonuclear/warfare/settings.py
sed -i "s/'PASSWORD': 'P@ssw0rd1',/        'PASSWORD': 'P@ssw0rd1',/g" /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "s/'HOST': 'NEEDTOADDIP',/        'HOST': '$ip1',/g" /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
sed -i "s/'PORT': '5432',/        'PORT': '5432',/g" /opt/django/thermonuclear-warfare/thermonuclear-warfare/settings.py
...
echo "from django.contrib.auth.models import User; User.objects.create_superuser('jonathan', 'wadejs@icloud.com', 'P@ssw0rd1')" | python manage.py shell
